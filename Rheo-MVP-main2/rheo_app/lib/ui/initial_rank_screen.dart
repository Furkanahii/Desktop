...
List<RankOption> get _rankOptions => [
  RankOption(S.rankUstat, 1000, '👑', const Color(0xFFD32F2F)),
  RankOption(S.rankUsta, 800, '⚡', const Color(0xFF7B1FA2)),
  RankOption(S.rankUzman, 600, '🎯', const Color(0xFF1976D2)),
  RankOption(S.rankDeneyimli, 400, '💡', const Color(0xFFD81B60)),
  RankOption(S.rankYukselen, 200, '📈', const Color(0xFF388E3C)),
  RankOption(S.rankCaylak, 0, '🌱', const Color(0xFF795548)),
];
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                isReset ? S.seviyeSecimi : S.tr('Hoş Geldin! 🎉', 'Welcome! 🎉'),
                style: TextStyle(
                  fontSize: 28,
              ...
              Text(
                isReset
                    ? S.tr('Yeniden başlamak istediğin seviyeyi seç', 'Choose the level you want to restart from')
                    : S.tr('Kendini hangi seviyede görüyorsun?', 'What level do you see yourself at?'),
                style: TextStyle(
                  fontSize: 14,
  ...
  void _selectRank(BuildContext context, RankOption rank) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          S.tr('${rank.startElo} puandan başlamak istediğine emin misin?', 'Are you sure you want to start from ${rank.startElo} points?'),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      S.tr('${widget.rank.startElo} puandan başla', 'Start from ${widget.rank.startElo} pts'),
                      style: TextStyle(
                        fontSize: 12,
