...
class RankScreen extends StatelessWidget {
  ...
  /// Build ranks with localized titles — colors and emojis are ELO-fixed
  static List<_RankInfo> get _ranks => [
    _RankInfo(S.rankUstat, 1000, '👑', const Color(0xFFD32F2F)),
    _RankInfo(S.rankUsta, 800, '⚡', const Color(0xFF7B1FA2)),
    _RankInfo(S.rankUzman, 600, '🎯', const Color(0xFF1976D2)),
    _RankInfo(S.rankDeneyimli, 400, '💡', const Color(0xFFD81B60)),
    _RankInfo(S.rankYukselen, 200, '📈', const Color(0xFF388E3C)),
    _RankInfo(S.rankCaylak, 0, '🌱', const Color(0xFF795548)),
  ];
