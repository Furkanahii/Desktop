      ...
      builder: (context) => Dialog(
        ...
        child: GlassCard(
          ...
          child: Column(
            ...
            children: [
              Text(S.tr('⏱️ Time Attack Bitti!', '⏱️ Time Attack Complete!'), 
                            ...
                            GlassCard(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    S.tr('Doğru cevap: ${_controller.currentQuestion?.correctAnswer ?? ""}', 'Correct answer: ${_controller.currentQuestion?.correctAnswer ?? ""}'),
