...
class S {
  ...
  static String get bugHunter => tr('Hata Avcısı', 'Bug Hunter');
  static String get bugHunterSub => tr('Hatalı satırı bul', 'Find the buggy line');
  static String get timeAttack => tr('Zamana Karşı', 'Time Attack');
  ...
  static String get gundeSoruSayisi => tr('Günde kaç soru çözmek istiyorsun?', 'How many questions do you want to solve per day?');
  ...
  static String get profiliOzellestir => tr('Profili Özelleştir', 'Customize Profile');
  static String get kullaniciAdi => tr('KULLANICI ADI', 'USERNAME');
  static String get kullaniciAdiHint => tr('Kullanıcı Adı', 'Username');
  static String get avatarSec => tr('AVATAR SEÇ', 'CHOOSE AVATAR');
